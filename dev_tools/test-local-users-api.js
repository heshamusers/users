/**
 * @file test-local-users-api.js
 * @description E2E test script for local Users API endpoints
 * 
 * This script tests all API calls documented in users-identity-api-calls.md
 * using the local users project API endpoints (Turso-based).
 */
...
async function runAllTests() {
    console.log('========================================');
    console.log('Local Users API E2E Test Suite');
    console.log('========================================');
    ...
    try {
        ...
        console.log('[ERROR] Server is not running. Please start the users project server first.');
        console.log('[INFO] Run: cd C:\\Users\\hesham\\Desktop\\users && npm run dev');
        return testResults;
    }
