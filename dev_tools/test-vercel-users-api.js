/**
 * @file test-vercel-users-api.js
 * @description E2E test script for Vercel Users API endpoints
 * 
 * This script tests all API calls documented in users-identity-api-calls.md
 * using the Vercel deployment of the users project.
 */

import https from 'https';

// Configuration
const VERCEL_API_URL = 'https://users-two-delta.vercel.app';
...
async function runAllTests() {
    console.log('========================================');
    console.log('Vercel Users API E2E Test Suite');
    console.log('========================================');
    console.log(`API_URL: ${VERCEL_API_URL}`);
